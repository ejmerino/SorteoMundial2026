...
export const TEAMS: Team[] = [
  ...
  { name: 'UEFA Play-off A', code: 'uefa-a', confederation: 'UEFA', pot: 4 },
  { name: 'UEFA Play-off B', code: 'uefa-b', confederation: 'UEFA', pot: 4 },
  { name: 'UEFA Play-off C', code: 'uefa-c', confederation: 'UEFA', pot: 4 },
  { name: 'UEFA Play-off D', code: 'uefa-d', confederation: 'UEFA', pot: 4 },
];
