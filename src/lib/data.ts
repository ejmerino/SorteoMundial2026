...
export const TEAMS: Team[] = [
  ...
  { name: 'Egypt', code: 'eg', confederation: 'CAF', pot: 3 },
  ...
  { name: 'Inter-Conf. Play-off A', code: 'fifa', confederation: 'PLAYOFF_A', pot: 4 },
  { name: 'Inter-Conf. Play-off B', code: 'fifa', confederation: 'PLAYOFF_B', pot: 4 },
  { name: 'UEFA Play-off A', code: 'uefa', confederation: 'UEFA', pot: 4 },
  { name: 'UEFA Play-off B', code: 'uefa', confederation: 'UEFA', pot: 4 },
  { name: 'UEFA Play-off C', code: 'uefa', confederation: 'UEFA', pot: 4 },
  { name: 'UEFA Play-off D', code: 'uefa', confederation: 'UEFA', pot: 4 },
];
